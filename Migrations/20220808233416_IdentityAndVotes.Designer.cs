...
namespace Voting_App.Migrations
{
    ...
    [Migration("20220808233416_IdentityAndVotes")]
    partial class IdentityAndVotes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Voting_App.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ApplicationUserVote", b =>
                {
                    b.HasOne("Voting_App.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UsersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Voting_App.Models.Vote", null)
                        .WithMany()
